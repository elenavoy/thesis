...
The preliminary framework was designed with the goal to support information discovery and curation~\cite{voyloshnikova2014}. The framework is presented in Tables , with the goal to illustrate how the framework evolved.
