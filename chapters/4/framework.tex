...
The framework consists of five main categories (navigation, exploration, curation, channeling of information, and integration) that are consequently decomposed into subcategories. Each subcategory contains factors that determine use case enablers and corresponding questions that can help application design and evaluation. This chapter outlines the main components of the framework. 

{\section{Discovery and Navigation}
In order to discover new information, a user needs to have a way of navigating to it. 


\begin{table}[h]
\begin{tabular}{ll}
Mechanism                                                         & Support and automation                  \\
                                                                  &                                         \\
\textbf{Descriptional: The user describes what is wanted}         &                                         \\
Search-based navigation                                           & Tailoring results                       \\
                                                                  & Suggesting search terms (guided search) \\
                                                                  &                                         \\
\textbf{Referential: The user selects orrefers to what is wanted} &                                         \\
Category-guided navigation                                        &                                         \\
Facet-guided navigation                                           &                                         \\
                                                                  &                                         \\
                                                                  &                                        
\end{tabular}
\end{table}
