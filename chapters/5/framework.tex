...
Understanding the motives behind user activities can help form a conceptual model of a needed Web application and its features. There exists a wide variety of user motives behind information discovery and curation, and certain aspects of these motives can significantly impact the design of an application. The following generalized motives and their properties can help define conceptual models and identify primary use cases of Web tools for information discovery and curation.  

{\subsection{Closing Knowledge Gap}
The primary motive for information discovery is usually to close some knowledge gap that occurred as a result of the user trying to accomplish some task and not having enough information to do so.   This motive is highly generalized; however, motives become more diverse with different information needs, and relation to temporality and persistence.   

{\subsubsection{Nature of Information Need}
Depending on the context in which it arose, an information need can have various degrees of specificity. For example, if the motive is to find inspiration for a project, the information need is only vaguely defined. However, if the motive is to find a phone number of a specific business, the information need is well-defined.  The specificity of the information need determines whether users can benefit more from mechanisms that allow to define the information need, help articulate the information need, or allow to randomly retrieve information, for instance.

The nature of the information need predetermines whether discovery is respectively serendipitous or oriented towards fact finding. In some cases, the information need may not be articulated at all, and the user might not be aware of the existing knowledge gap.   
...
The main motive behind information curation is making it possible to reaccess information in the future and subsequently use it. 
}
...
Reportedly, people collect information for the sake of collecting information~\cite{lindley2012s}. That is, collecting is an activity in itself. 

}
Even though it is not feasible to list all of the possible motives for information discovery and curation, the framework outlines the important properties of the motives that can aid in developing use cases and formalizing conceptual models for Web applications. 
...
Filter-guided navigation  		& Can users navigate using filters? \\
