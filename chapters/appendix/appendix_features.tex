\startappendix{Sample Enabling Mechanisms of the Conceptual Framework for Information Discovery and Curation}
...
\includegraphics[width=0.8\linewidth]{visual_preview.png}\\
\\
