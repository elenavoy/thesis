...
To address RQ1 and RQ2, I conducted a systematic literature review (see Section~\ref{section:lit_review}) and a case study of 20 information disocvery tools (see Section~\ref{section:building}). 

Using insightI then developed and validated a conceptual framework to address RQ3 (see Sections~\ref{section:building}, \ref{section:applying}, \ref{section:validating}). 
}% end section
