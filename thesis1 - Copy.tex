...
\thesistitle{TOWARDS UNDERSTANDING DIGITAL INFORMATION DISCOVERY AND CURATION}  %- Use capital letters
...
\prevdegree{B.Sc., University of Victoria, 2012}

%- Let latex know about the committee members,
%-    in the order you want them

\committeemember{Dr.~Margaret-Anne Storey, Supervisor,\\ Dept.~of
Computer Science}
\committeemember{Dr.~Melanie Tory, Member,\\
Dept.~of Computer Science} 
\committeemember{Dr.~Ray Siemens, External Examiner}
...
\halfinfo{Voyloshnikova}{Elena}{Nikolaev, Ukraine}
...
\makecopyrightpage{21 April 2015}   %- Date below signature
